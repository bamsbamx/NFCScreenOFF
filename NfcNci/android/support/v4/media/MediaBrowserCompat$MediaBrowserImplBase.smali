...
# direct methods
.method static synthetic -get0(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/support/v4/media/MediaBrowserCompat$ConnectionCallback;
    .registers 2
...
.method static synthetic -get1(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/os/Messenger;
    .registers 2
...
.method static synthetic -get2(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/content/Context;
    .registers 2
...
.method static synthetic -get3(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/support/v4/media/MediaBrowserCompat$CallbackHandler;
    .registers 2
...
.method static synthetic -get4(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/os/Bundle;
    .registers 2
...
.method static synthetic -get5(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/support/v4/media/MediaBrowserCompat$ServiceBinderWrapper;
    .registers 2
...
.method static synthetic -get6(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/content/ComponentName;
    .registers 2
...
.method static synthetic -get7(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection;
    .registers 2
...
.method static synthetic -get8(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)I
    .registers 2
...
.method static synthetic -set0(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;Landroid/os/Messenger;)Landroid/os/Messenger;
    .registers 2
...
.method static synthetic -set1(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;Landroid/support/v4/media/MediaBrowserCompat$ServiceBinderWrapper;)Landroid/support/v4/media/MediaBrowserCompat$ServiceBinderWrapper;
    .registers 2
...
.method static synthetic -set2(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;I)I
    .registers 2
...
.method static synthetic -wrap0(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;)V
    .registers 1
...
.method public connect()V
    ...
    .line 782
    :cond_93
    iput v6, p0, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;->mState:I
    ...
    invoke-direct {v3, p0, v5}, Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection;-><init>(Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase;Landroid/support/v4/media/MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection;)V
    ...
    :try_end_b2
    .catch Ljava/lang/Exception; {:try_start_aa .. :try_end_b2} :catch_d2
...
.method public disconnect()V
    ...
    :try_end_b
    .catch Landroid/os/RemoteException; {:try_start_4 .. :try_end_b} :catch_21
...
.method public onLoadChildren(Landroid/os/Messenger;Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)V
    ...
    .line 1096
    invoke-virtual {v2, p2, p3}, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->onChildrenLoaded(Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 1098
    :cond_6f
    invoke-virtual {v2, p2, p3, p4}, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->onChildrenLoaded(Ljava/lang/String;Ljava/util/List;Landroid/os/Bundle;)V
...
.method public onServiceConnected(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    .local v8, "subscriptionEntry$iterator":Ljava/util/Iterator;
    :cond_65
    ...
    invoke-static {v9}, Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;->-get2(Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)Landroid/os/IBinder;
    ...
    :try_end_a3
    .catch Landroid/os/RemoteException; {:try_start_5b .. :try_end_a3} :catch_a6
    ...
    .end local v8    # "subscriptionEntry$iterator":Ljava/util/Iterator;
    :catch_a6
    move-exception v2
